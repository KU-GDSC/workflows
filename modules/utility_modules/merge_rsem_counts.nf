...
process MERGE_RSEM_COUNTS {
  ...
  script:
      ...
      paste gene_ids.txt tmp/genes/*.counts.tsv > rsem.merged.gene_counts.tsv
      paste gene_ids.txt tmp/genes/*.tpm.tsv > rsem.merged.gene_tpm.tsv
      paste transcript_ids.txt tmp/isoforms/*.counts.tsv > rsem.merged.isoform_counts.tsv
      paste transcript_ids.txt tmp/isoforms/*.tpm.tsv > rsem.merged.isoform_counts.tsv
      """
  }
